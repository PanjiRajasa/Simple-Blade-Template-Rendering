...
@section('title', 'Sejarah Desa Sulangai')
...
@section('content')
  ...
  <section class="hero" role="banner">
    <div class="hero-content">
      <h1>Sejarah Desa <span style="color:#2c9e31">Sulangai</span></h1>
      <p class="hero-subtitle">Ringkasan perjalanan desa dari masa awal hingga kini—menjadi komunitas yang rukun, lestari, dan berdaya.</p>
    </div>
  </section>
  ...
  <div class="news-grid">
    <article class="news-card">
      <div class="card-body">
        <h2 style="font-weight:800; margin-bottom:20px; text-align:center; color: var(--text-dark);">
          Sejarah Desa Sulangai
        </h2>

        <div style="width:100%; display:flex; justify-content:center; margin-bottom:25px;">
          <div style="height:4px; width:120px; background:linear-gradient(to right, var(--primary-green), var(--accent-blue)); border-radius:2px;"></div>
        </div>
        ...
        <p class="lead">
          ...
          <p class="lead">
          <strong>Sejarah Singkat Desa Sulangai</strong>
          </p>
          ...
          <p class="lead">
          Om een ​​lang verhaal kort te maken, door zijn vermogen om zich vast te klemmen, vond hij ergens licht en de plaats werd onmiddellijk gezocht en het licht werd gevonden in een bos, dat Tegal Gunung heette (nu staat er een tempel genaamd Pura Pucak Manik). Daar ging hij weer mediteren zodat hij een hint kreeg dat rond die plek de juiste plek was om een ​​kasteel te bouwen. En het gebied waar dit kasteel moest worden gebouwd, werd Avond genoemd naar het woord <strong>"Ngepit"</strong>, dan verschijnt voor de veiligheid en anderen zoals hierboven vermeld een banjar genaamd het Petang Village-gebied, zoals: Banjar Sandakan, Banjar Sulangai, Banjar Batulantang, Banjar Angantiga, Banjar Munduk Damping, Banjar Lipah, Banjar Kerta, Banjar Avond, Banjar Sekarmuti, Banjar Pundung, Banjar Kasianan en Banjar Pangsan.
          </p>
          ...
          <p class="lead">
          <strong>Secara administratif,</strong> untuk memberikan pelayanan agar lebih efektif dan efisien dengan memperhatikan wilayah yang cukup luas maka pada tahun 1997 diadakan pemekaran dimana Desa Petang dimekarkan menjadi 3 ( tiga ) Desa Dinas yaitu:
          </p>
          ...
          <p class="lead">
          <strong>Adapun yang pernah memimpin Petang dari baru adanya Petang sampai saat ini adalah sebagai berikut:</strong>
          </p>
          ...
          <br>
          10. I Wayan Suryaantara SH dari bulan Oktober 2009 sampai sekarang, melalui pemilihan langsung masyarakat.
          </p>

          <p class="lead">
          <strong>Sementara pemimpin Sulangai dari masa persiapan antara lain:</strong>
          </p>
          ...
          <br>
          5. I Nyoman Sunarta, dari tahun 2021 sd sekarang
          </p>

        <h3 style="margin:30px 0 15px; color: var(--primary-green);">Filosofi & Nilai</h3>
        <p class="muted">Keharmonisan manusia, alam, dan budaya menjadi landasan pembangunan.</p>
      </div>
    </article>
  </div>
